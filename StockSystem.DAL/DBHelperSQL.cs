...
namespace StockSystem.DAL
{
    ...
    {
        //连接用的字符串  
        private string connStr = ConfigurationSettings.AppSettings["DBConn"];
        ...
        //DbManager单实例  
        private static DBHelperSQL _instance = null;
        public static DBHelperSQL Ins
        {
            get { if (_instance == null) { _instance = new DBHelperSQL(); } return _instance; }
        }
